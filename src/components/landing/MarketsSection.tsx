                  ...
                  {displayed.map((pair, i) => (
                    ...
                    >
                      ...
                      <td className="py-3.5 pr-4 text-right">
                        <Link href="/dashboard/trade" className="text-sm font-mono text-text-primary hover:text-brand tabular-nums">
                          ${formatNumber(pair.price, pair.price < 10 ? 4 : 2)}
                        </Link>
                      </td>
                      <td className="py-3.5 pr-4 text-right">
                      ...
                      <td className="py-3.5 text-right">
                        <Link href="/dashboard/trade" className="text-sm font-mono text-text-tertiary hover:text-text-primary tabular-nums">
