    ...
    sections: [
      {
        ...
        summary: "Using ONYX means you agree to these terms.",
        paragraphs: [
          "These Terms of Use (\"Terms\") constitute a legally binding agreement between you and Onyx Exchange (\"ONYX\", \"we\", \"us\", or \"our\") governing access to and use of our website, mobile experience, APIs, and related services (collectively, the \"Platform\").",
        ...
        highlight:
          "Your continued use of ONYX after we publish updated Terms constitutes acceptance of those changes.",
      },
      {
        id: "eligibility",
      ...
      },
      {
        ...
        summary: "What ONYX provides and what we do not guarantee.",
        paragraphs: [
          "ONYX provides digital asset trading, portfolio tools, deposit and withdrawal workflows, market data, and optional automated or copy-trading features. Availability of specific assets, pairs, or features may vary by region and account status.",
          ...
          "Market data, charts, and analytics are provided for informational purposes. ONYX does not provide investment, tax, or legal advice.",
        ],
        bullets: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "You are solely responsible for providing correct wallet addresses, bank details, or payout instructions. ONYX is not liable for losses caused by incorrect recipient information supplied by you.",
        ],
      },
      {
        id: "risk",
        ...
        highlight:
          "By using ONYX, you acknowledge that you assume full responsibility for your trading decisions and outcomes.",
      },
      {
        id: "conduct",
        ...
        bullets: [
          ...
          "Uploading malware, harassing staff or users, or impersonating ONYX personnel.",
        ],
      },
      {
        id: "ip",
        title: "7. Intellectual Property",
        summary: "Ownership of ONYX brand, software, and content.",
        paragraphs: [
          "The Platform, including its design, logos, software, documentation, and proprietary data feeds, is owned by ONYX or its licensors and protected by intellectual property laws.",
      ...
      },
      {
        ...
        summary: "How liability is allocated between you and ONYX.",
        paragraphs: [
          ...
          "TO THE MAXIMUM EXTENT PERMITTED BY LAW, ONYX AND ITS AFFILIATES, OFFICERS, EMPLOYEES, AND AGENTS SHALL NOT BE LIABLE FOR INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, OR FOR LOSS OF PROFITS, DATA, OR GOODWILL.",
          "Our aggregate liability for any claim arising from or related to the Platform shall not exceed the greater of (a) fees paid by you to ONYX in the twelve months preceding the claim or (b) one hundred U.S. dollars (USD $100).",
        ],
      },
      {
        id: "termination",
    ...
    sections: [
      {
        ...
        paragraphs: [
          "Onyx Exchange (\"ONYX\", \"we\", \"us\") respects your privacy and is committed to handling personal information responsibly. This Privacy Policy explains what data we collect, why we collect it, how we use and share it, and the choices available to you.",
      ...
      },
      {
        ...
        paragraphs: [
          "The information we collect depends on how you use ONYX. Some data is provided directly by you; other data is collected automatically when you interact with the Platform.",
        ],
        bullets: [
      ...
      },
      {
        ...
        paragraphs: [
          "ONYX may process and store information in countries other than your country of residence. Where required, we implement Standard Contractual Clauses, adequacy decisions, or other approved transfer mechanisms to protect your data.",
        ],
      },
      {
        id: "retention",
