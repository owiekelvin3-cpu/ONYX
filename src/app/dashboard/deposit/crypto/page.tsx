...
import { AlertTriangle, ArrowLeft, Check, Copy, Loader2 } from "@/components/icons";
    ...
    <div className="space-y-4 max-w-2xl">
      <div>
        ...
        <p className="text-[13px] text-text-tertiary mt-1">
          Send crypto to our wallet address, then submit your deposit for verification.
        </p>
      </div>
      ...
      <Card>
        <div className="space-y-4">
          ...
          <Button type="button" className="w-full" disabled={submitting || !userId} onClick={handleSubmit}>
            {submitting ? (
