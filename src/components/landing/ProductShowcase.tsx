...
const ICONS = [LineChart, TrendingUp, Copy, Bot] as const;
      ...
      <div className="container-app relative">
        <FadeUp>
          <h2 className="text-xl sm:text-2xl font-bold text-text-primary mb-2 text-balance">
            Spot, futures, copy, bots
          </h2>
          <p className="text-sm text-text-tertiary mb-8 sm:mb-10 max-w-lg">
            Four ways to trade — same dashboard, same fee structure. Pick what fits how you actually work.
          </p>
        </FadeUp>
